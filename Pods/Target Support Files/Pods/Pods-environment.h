...
// MarshmallowCore
#define COCOAPODS_POD_AVAILABLE_MarshmallowCore
#define COCOAPODS_VERSION_MAJOR_MarshmallowCore 0
#define COCOAPODS_VERSION_MINOR_MarshmallowCore 0
#define COCOAPODS_VERSION_PATCH_MarshmallowCore 6
